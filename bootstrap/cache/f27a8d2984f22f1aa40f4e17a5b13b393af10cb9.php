            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo e($product->image); ?>" alt="" style="max-width:150px; max-height:200px;"></td>
                        <td><?php echo e($product->name); ?></td>
                        <td><?php echo e($product->price); ?></td>
                        <td>
                            <a href="/admin/product/<?php echo e($product->id); ?>/edit"><i class="fa fa-edit text-dark"></i></a>
                            <a href="/admin/product/<?php echo e($product->id); ?>/delete"><i class="fa fa-trash text-danger"></i></a>
                        </td>
                    </tr>
